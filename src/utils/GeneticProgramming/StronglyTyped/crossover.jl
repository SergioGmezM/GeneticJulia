...
function onePointCross(parent1::STGPGenotype, parent2::STGPGenotype,
    ...
    cantCross = false
    lenRep = length(getRepresentation(parent1))
    ...
    if !cantCross
        ...
        child1Tree = deepcopy(getRepresentation(parent1))
        child2Tree = deepcopy(getRepresentation(parent2))
    end
...
function oneChildSubtreeCross(parent1::STGPGenotype, parent2::STGPGenotype,
    ...
    if !cantCross
        ...
        childTree = deepcopy(getRepresentation(parent1))
    end
