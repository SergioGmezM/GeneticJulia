...
"""
    evaluate(phenotype::Expr, varsDict::NamedTuple)
...
"""
function evaluate(phenotype::Expr, varsDict::NamedTuple)
...
"""
    evaluate(phenotype::Expr, variables::Array{String}, varValues...)
...
evaluate GP individuals.
"""
function evaluate(phenotype::Expr, variables::Array{String}, varValues...)
...
evaluate GP individuals.
"""
function evaluate(phenotype::Expr)
