...
"""
    printExperimentInfo(genj::GeneticJuliaStructure = GenJ)

documentation
"""
function printExperimentInfo(outputFile::String = "", genj::GeneticJuliaStructure = GenJ)
    ...
    if genj._evaluator._globalFitnessFunction._fitnessFunction != noFunc
