"""
    setMutationOperator(method::Function, varArgs...; genj::GeneticJuliaStructure = GenJ,
...
"""
function setMutationOperator(method::Function, varArgs...; genj::GeneticJuliaStructure = GenJ,
                             probability::AbstractFloat = 0.3)
...
"""
function setNullMutation(; genj::GeneticJuliaStructure = GenJ)
    noFunction() = nothing
