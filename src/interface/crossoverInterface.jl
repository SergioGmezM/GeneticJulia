"""
    setCrossoverOperator(method::Function, varArgs...; genj::GeneticJuliaStructure = GenJ,
...
"""
function setCrossoverOperator(method::Function, varArgs...; genj::GeneticJuliaStructure = GenJ,
                              probability::AbstractFloat = 0.7, nParents::Integer = 2,
                              nChildren::Integer = -1)
...
"""
function setNullCrossover(;genj::GeneticJuliaStructure = GenJ)
    noFunction() = nothing
